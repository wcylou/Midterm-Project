...
INSERT INTO `midterm`.`profile` (`id`, `first_name`, `last_name`, `age`, `gender`, `sexual_orientation`, `about_me`, `location_id`, `user_id`, `picture_url`, `min_age`, `max_age`) VALUES (6, 'AnotherTest', 'Asfasfsdll', 30, 'Woman', 'Heterosexual', 'asdf', 6, 6, 'https://www.sprout.nl/sites/default/files/field/image/mark_zuckerberg_1.jpg', 18, 80);
...
COMMIT;-- MySQL Workbench Forward Engineering
